...
const AnimatedText = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        async function sequence() {
            // Slide the text from off-screen right (110%) into center over 2 seconds.
            ...
            // Optionally, wait a moment (if desired, you can add a delay here)
            // Then fade out the text (e.g., over 0.5 seconds)
            await controls.start({
                opacity: 0,
                transition: {
                    duration: 0.5
...
const __TURBOPACK__default__export__ = AnimatedText;
 ...
 //   useEffect(() => {
 //     if (!scope.current || !intro) return;
 //     const runAnimation = async () => {
 //       console.log("Animation starts");
 //       // Move to original position
 //       await animate(scope.current, { x: 0 }, { duration: 3 });
 //       // Fade out after movement is complete
 //       await animate(scope.current, { opacity: 0 }, { duration: 0.5 });
 //       console.log("Animation ends");
 //       setIntro(false); // Set state after animation is fully completed
 //     };
 //     runAnimation();
 //   }, [scope, intro]);
 //   if (intro) {
 ...
 //           style={{ transform: "translateX(110%)", opacity: 1 }}
 //         >
 //           Kismat creates
 //         </span>
 //       </section>
...
//# sourceMappingURL=_a07335._.js.map